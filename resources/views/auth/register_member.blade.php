            ...
            <div class="w-full lg:w-1/2 bg-white p-10 px-5 md:px-20">
                ...
                <form action="/register_member " class="mt-10" method="POST">
                    ...
                    <div class="my-3">
                        ...
                        <input required type="text" placeholder="Member Name" name="member_name" id="member_name" class="block border-2 rounded-full mt-2 py-2 px-5 w-full">
                    </div>
                    <div class="my-3">
                        <label class="font-semibold" for="telephone">Phone Number</label>
                        <input required type="text" placeholder="Phone Number" name="telephone" id="telephone" class="block border-2 rounded-full mt-2 py-2 px-5 w-full">
                    </div>
                    <div class="my-3">
                    ...
                    <div class="my-3">
                        <label class="font-semibold" for="password_confirmed">Confirm Password</label>
                        <input required type="password" placeholder="Confirm Password" name="password_confirmed" id="password_confirmed" class="block border-2 rounded-full mt-2 py-2 px-5 w-full">
                    </div>
                    <div class="my-5">
